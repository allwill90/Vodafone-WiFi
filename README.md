This is a script written in bash that lets you automatically connect and refresh connections to Vodafone Hotspots in Italy (although it should work for other countries too with slight modification to the url and the parameters which i didn't bother to do since i haven't had the need to use this abroad).
